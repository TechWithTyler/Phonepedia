...
struct BaseCallerIDView: View {
    ...
    var body: some View {
        ...
        • Anonymous/Unavailable/Unknown: Caller ID information isn't available for this call. Depending on the provider/device, data won't be transmitted at all in this case. This is not to be confused with Private, which is when caller ID information is available but blocked.
        ...
        • Toll-Free: The call is coming from a toll-free number (e.g. any number in area code 800, 833, 844, 855, 866, 877, or 888 in the US), and a name isn't available.
        """)
