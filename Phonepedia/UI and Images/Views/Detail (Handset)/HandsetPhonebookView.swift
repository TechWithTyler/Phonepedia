...
struct HandsetPhonebookView: View {
    ...
    var body: some View {
        if handset.handsetStyle < 3 {
            FormNumericTextField("Capacity", value: $handset.phonebookCapacity, valueRange: 0...Int.max, singularSuffix: "entry", pluralSuffix: "entries")
#if !os(visionOS)
                .scrollDismissesKeyboard(.interactively)
#endif
            FormNumericTextField("Numbers Per Entry", value: $handset.numbersPerPhonebookEntry, valueRange: 1...5, singularSuffix: "number", pluralSuffix: "numbers")
#if !os(visionOS)
                .scrollDismissesKeyboard(.interactively)
#endif
        ...
        if handset.phonebookCapacity > 0 {
            FormNumericTextField("Favorite Entry Capacity", value: $handset.favoriteEntriesCapacity, valueRange: 0...10, singularSuffix: "entry", pluralSuffix: "entries")
