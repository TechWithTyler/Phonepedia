        ...
        if let phone = handset.phone {
            ...
            Section("Headsets") {
                ...
                if handset.handsetStyle < 3 {
                    CountPicker("Maximum Number of Bluetooth Headphones", selection: $handset.bluetoothHeadphonesSupported, startNumber: 1, multipliedBy: 2, endNumber: 4, noneTitle: "None", unlimitedTitle: "Unlimited")
                }
            }
