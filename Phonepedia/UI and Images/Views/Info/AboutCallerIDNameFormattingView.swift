        ...
        NavigationStack {
            List {
                ...
                DisclosureGroup {
                    ...
                    Text("Example STIR/SHAKEN verified caller name: \"Spam?\(exampleName)\"")
                } label: {
