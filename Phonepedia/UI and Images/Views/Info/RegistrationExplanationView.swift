        ...
        NavigationStack {
            ...
            List {
                ...
                DisclosureGroup("Registration") {
                    ...
                    Text("Deregistering a handset deletes the registration information from the handset and base. On some phones, you can also forget the base(es) the handset's registered to, or forget the handsets that are registred to the base, if the previous base/handset aren't available. Some phones only support deregistration by registering a handset over the registration of an unused handset, then registering the handset back to the desired slot.")
