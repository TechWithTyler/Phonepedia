...
• Greeting only mode: Whether to play the greeting and not accept incoming messages. Depending on the phone, this may be an option in the recording time setting instead of a separate setting.
