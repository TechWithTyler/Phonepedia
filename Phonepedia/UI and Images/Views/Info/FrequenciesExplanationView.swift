    ...
    var body: some View {
        NavigationStack {
            List {
                ...
                Text("Since Bluetooth operates on the same frequency as 2.4GHz cordless phones, there are no such phones with Bluetooth. The widespread use of Wi-Fi and Bluetooth today makes 2.4GHz cordless phones prone to interference.")
                Text("US and Canada use a slightly different version of DECT, DECT 6.0. 6.0 was chosen as the number instead of 1.9 so people who think \"higher number is better\" will know DECT 6.0 is better than 5.8GHz, 2.4GHz, and 900MHz phones, even though the actual frequency is 1.92-1.93GHz.")
