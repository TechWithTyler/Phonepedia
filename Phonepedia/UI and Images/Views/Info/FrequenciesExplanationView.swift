        ...
        NavigationStack {
            List {
                ...
                DisclosureGroup("DECT (Digital Enhanced Cordless Telecommunications)") {
                    ...
                    Text("1.88–1.890GHz (1880–1890MHz) is used for DECT in Europe, the UK, Ireland, Australia, New Zealand, and the Middle East.")
                ...
                DisclosureGroup("Marketing vs Actual Frequency Range") {
                    ...
                    Text("DECT in the US uses the 1.92-1.93GHz (1920-1930MHz) frequency range, often referred to as simply 1.9GHz. However, it's more commonly referred to as DECT 6.0 so people who think \"higher number is better\" will know DECT 6.0 is better than 5.8GHz, 2.4GHz, and 900MHz phones. DECT in other countries uses different frequency ranges as explained in the above section.")
                }
            }
