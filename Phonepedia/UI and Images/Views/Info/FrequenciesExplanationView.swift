        ...
        NavigationStack {
            List {
                ...
                DisclosureGroup("DECT (Digital Enhanced Cordless Telecommunications)") {
                    Text("DECT (1.8-1.9GHz) uses encryption, making it the most secure cordless phone frequency. And since it's dedicated to cordless phones, baby monitors, and related devices, other wireless devices won't interfere with the phone, and in most cases, DECT devices won't interfere with each other.")
                    Text("North America uses a slightly different version of DECT, DECT 6.0 (1.9GHz).")
                }
                DisclosureGroup("Marketing vs Actual Frequency Range") {
                    ...
                    Text("DECT in the US uses the 1.92-1.93GHz (1920-1930MHz) frequency range, often referred to as simply 1.9GHz. However, it's more commonly referred to as DECT 6.0 so people who think \"higher number is better\" will know DECT 6.0 is better than 5.8GHz, 2.4GHz, and 900MHz phones. Regular DECT, used elsewhere, uses frequencies ranging from 1.88GHz (1880MHz) to 1.92GHz (1920MHz), often referred to as simply 1.8GHz, 1.9GHz, or 1.8-1.9GHz.")
                }
            }
