        ...
        NavigationStack {
            List {
                ...
                DisclosureGroup("Dual-Band/Frequency Ranges") {
                    ...
                    Text("\"Frequency 1-Frequency 2\" (e.g., 1.92GHz-1.93GHz) means that the phone operates in a range of frequencies, not just one specific frequency. The frequencies are within a few MHz of each other.")
                }
