        ...
        NavigationStack {
            ...
            List {
                ...
                DisclosureGroup {
                    ...
                    Text("Because hotel phones are often customized with hotel-speficic information, you may not be able to find one for your phone collection that wasn't previously ordered for a specific hotel.")
                    Text("Some hotels use residential phones in their rooms. You can use a residental phone on a hotel line and vice versa as long as their connection types are the same (e.g. an analog residential cordless phone on a hotel room's analog line).")
                } label: {
                    Text("Hotel Phone")
                }
                DisclosureGroup {
