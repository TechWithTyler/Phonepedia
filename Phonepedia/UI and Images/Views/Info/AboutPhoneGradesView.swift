        ...
        NavigationStack {
            ...
            List {
                ...
                DisclosureGroup {
                    ...
                    Text("Some hotels use residential phones in their rooms. You can use a residential phone on a hotel line and vice versa as long as their connection types are the same (e.g. an analog residential cordless phone on a hotel room's analog line). If a hotel room's phone is a residential phone, there's a risk of guests changing settings or messing up the phone.")
                } label: {
                    Text("Hotel Phone")
                }
                DisclosureGroup {
