...
struct BatteryInfoView: View {
    var body: some View {
        InfoText("""
• Battery packs with plugs are the most common for cordless phones, but the plugs have the tendency to break off of the wires that connect to the batteries in the pack.
