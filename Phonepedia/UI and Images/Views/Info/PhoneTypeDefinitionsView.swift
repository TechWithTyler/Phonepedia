...
struct PhoneTypeDefinitionsView: View {
    ...
    let cordedPhoneStyleDictionary: [DictionaryEntry] = [
        ...
        DictionaryEntry(Phone.CordedPhoneStyle.baseless.rawValue, definition: "A corded phone that doesn't have a base. The phone is a single device that plugs into the line. Many phones of this style have a hook switch that gets pressed by being placed on a flat surface, while some have an on/off switch or a cover you flip open."),
