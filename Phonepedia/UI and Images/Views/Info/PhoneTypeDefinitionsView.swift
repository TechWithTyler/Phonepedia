...
struct PhoneTypeDefinitionsView: View {
    ...
    let dictionary: [DictionaryEntry] = [
        ...
        DictionaryEntry("\(Phone.PhoneType.corded.rawValue)", definition: "A traditional phone with a receiver which connects to the base using a cord (often coiled). These can have either mechanical/bell or electronic ringers and come in a range of styles from slim, basic wall phones to fully-featured desk phones."),
